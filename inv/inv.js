const config = {
  ...
  welcome_investors: {
    header: {
      name: "Welcome Investors",
      lastTimeUpdated: "17/09/2025",
      imgUrl: "https://raw.githubusercontent.com/cnhuya/AEXIS-CDN/main/menu/hi_investors.svg"
    },
    container: `
    <div class="box">
      <div class="row">
      ...
      <div class="toggle-content">
      <p>We are not the classic VC stacked bullshit, we are just three guys. Two of us are fresh graduates who finished our studies this year (2025), and the third is our manager, who helps us with social media, potential partnerships, and overall coordination. While we may not have a lot of experience yet, we are here to create something amazing. We hope you’ll give us a chance, because we are thinking big.</p>
      </div>
    </div>
    ...
    <div class="box">
      ...
      <div class="toggle-content">
        <p>
          Our goals are quite simple, we are building innovative technology to help people lose less and earn more, in not only fun ways but also new ways.
        </p>
<div class="list">
  <div class="">
    <div class="row">
  ...
  why_us: {
    header: {
      name: "Why Us?",
      lastTimeUpdated: "17/09/2025",
      imgUrl: "https://raw.githubusercontent.com/cnhuya/AEXIS-CDN/main/menu/why_us.svg"
    },
    container: `
   <div class="box">
  <div class="row">
  ...
  <div class="toggle-content">
    <p>
      We truly believe that we bring unique ideas that can brighten the Web 3.0 space as it stands today. With the technology we have already built and the concepts still on paper or in our heads we generate fresh ideas almost daily. That is our core strength.
    </p>
  </div>
</div>
...
<div class="box">
  ...
  <div class="toggle-content">
    <p>
      If you believe in technology, you will be rewarded. We aim to make our solutions as unique as possible. Even when something is similar to an existing idea, we always strive to push one step further. From building cross-chain lending & borrowing to non-liquidative perpetual trading, our goal is always to innovate.
    </p>
  </div>
</div>
...
<div class="box">
  ...
  <div class="toggle-content">
    <p>
      What if we told you that our product is essentially a combination of markets worth more than <b>$150 billion</b>, with the potential to grow to <b>$500 billion</b> in the future? Yes, that’s right. Below you can dive deeper into the numbers.
    </p>
  ...
  near_future: {
    header: {
      name: "Near Future",
      lastTimeUpdated: "17/09/2025",
      imgUrl: "https://raw.githubusercontent.com/cnhuya/AEXIS-CDN/main/menu/near_future.svg"
    },
    container: `
  <div class="box">
  <div class="row">
  ...
  <div class="toggle-content">
    ...
    <div class="list">
      <div class="">
        ...
        <p>Our upcoming major expansion and complete redesign of the product will introduce new features coming out of testnet such as Perpetuals Markets, Full Personification, along with code cleanup and optimization. The goal is to improve user experience with greater speed, visual clarity, and a more intuitive interface.</p>
        <p>If you would like to learn more about the Genesis Phase, please visit the Genesis tab under the Roadmap section.</p>
        </div>
    </div>
  </div>
</div>
...
<div class="box">
  ...
  <div class="toggle-content">
    <p>
      If you are interested in more than just upcoming features and want to explore ideas that are not yet confirmed for release, visit the Upcoming section in the Roadmap.
    </p>
  </div>
</div>
  ...
  numbers: {
    header: {
      name: "Dates",
      lastTimeUpdated: "17/09/2025",
      imgUrl: "https://raw.githubusercontent.com/cnhuya/AEXIS-CDN/main/menu/numbers.svg"
    },
    container: `
   <div class="box">
  <div class="row">
    <h4>First Public Demo</h4>
    <img class="toggle-arrow" style="margin-left: auto; cursor: pointer;" 
         src="https://raw.githubusercontent.com/cnhuya/AEXIS-CDN/main/menu/arrow_down.svg">
  </div>
  <div class="toggle-content">
    <p>
      We plan to release the first public demo of our project around the middle of October.
    </p>
  </div>
</div>
...
<div class="box">
  ...
  <div class="toggle-content">
    <p>
      Genesis is our first major upgrade and is scheduled to launch later this year. For more information, please check the Genesis tab under the Roadmap section.
    </p>
  </div>
</div>
...
<div class="box">
  ...
  <div class="toggle-content">
    <p>
      The first of our products to reach mainnet has not yet been set. We prefer not to announce a date and then postpone it if vulnerabilities are found. However, our goal is to bring the first products to mainnet within this year.
    </p>
  </div>
</div>
  ...
  non_liquidative_perpetuals: {
    ...
    <div class="box">
      ...
      <div class="toggle-content">
        <p>
          We will also built special unique non liquidative perpetual trading, which will innovate the Web 3.0 & Trading space.
        </p>
      </div>
    </div>
  ...
  time_based_perpetuals: {
    header: {
      name: "Perpetrual Trading",
      lastTimeUpdated: "30/08/2025",
      imgUrl: "https://raw.githubusercontent.com/cnhuya/AEXIS-CDN/main/menu/time_perpetruals.svg"
    },
    container: `
    <div class="box">
      <div class="row">
      ...
      <div class="toggle-content">
        <p>
          This is more for the degenerates, we some people like gambling, so we will introduce special perpetrual trading, with over 1,000x leverage, but time based. Lets say you predict that btc will go up 1% in hour, so you make your position to last 1 hour with up to 1,000x leverage.
          This feature can also be used for hedging for example: If there is FOMC meeting and high volatility is excepted and you are long you can use this feature and short. 
        </p>
        <p>PSA: The leverage automatically increases the closer to the expiration it is. Also the interest fee for this market is 5 minute, and maximum length is 12 hours</p>
        <p>DISCLAIMER: This feature is not implemented yet, so take these numbers lightly...</p>
      </div>
    </div>
  ...
  smart_trading: {
    ...
    <div class="box">
      ...
      <div class="toggle-content">
        <p>
          In the future, we will use the Supra Native built-in feature Automation, which allows automated transaction execution upon reaching some agreement.
        </p>
      </div>
    </div>
  ...
  implement: {
    ...
    <div class="box">
      ...
      <div class="toggle-content">
        <p>
       In the future, we want to open opportunities for developers and introduce a way to integrate our vaults into their projects.
        </p>
      </div>
    </div>
  ...
  genesis: {
    header: {
      name: "Genesis",
      lastTimeUpdated: "17/09/2025",
      imgUrl: "https://raw.githubusercontent.com/cnhuya/AEXIS-CDN/main/menu/genesis.svg"
    },
    container: `
<div class="box">
  <div class="row">
  ...
  <div class="toggle-content">
    <p>
      We are stepping up our behind-the-scenes technology and rebuilding our entire web stack. 
      The goal is to move toward a more modern and feature-rich system that includes built-in 
      optimization technologies. This means faster loading speeds, stronger SEO performance, 
      improved search capabilities, and an overall cleaner look and feel. We want our platform 
      to be enjoyable to use, visually clear, and highly responsive for everyone who visits. 
      In short, this is not just a minor update, but a foundational improvement to how our 
      entire website operates.
    </p>
  </div>
</div>
...
<div class="box">
  ...
  <div class="toggle-content">
    <p>
      No, we are not going for a complete rebrand. Qiara will remain Qiara. What we are planning 
      is more of a thoughtful refresh to the overall design and layout of the website. Some 
      elements you are already familiar with will stay the same, others will evolve, and new 
      features will appear. Think of it as giving Qiara a fresh coat of paint and some new tools 
      under the hood, while keeping the core identity intact. Change is healthy, and we want to 
      make sure the changes we introduce feel exciting and meaningful rather than overwhelming.
    </p>
  </div>
</div>
...
<div class="box">
  ...
  <div class="toggle-content">
    <p>
      With the Genesis Phase, we are introducing a number of new features that expand both 
      functionality and user experience. Below you can find a growing list of what is coming. 
    </p>
    <p>
      PSA: Sneak peek images of the new design may be shared on this blog once we officially 
      begin the rebuilding process.  
      Disclaimer: This list is still under active development. Some of the features listed here 
      may be adjusted, postponed, or replaced as we move forward. 
    </p>
...
<p>We are introducing built-in annual increasing burn fee model, which will help the scarcity of our token. Currently the burn fee formula is: (5) + ((year*0.1) + (year/5))</div>
  ...
  overview: {
    ...
    <div class="box">
      ...
      <div class="toggle-content">
        <p>
          For now, we do not track any protocol stats. However, in the future we will provide a public information about how our protocol is doing.
        </p>
      </div>
    </div>
